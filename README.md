...
# DL-DiscoMT - Tamil to Hindi MT - V2
...
Download the model from the provided drive link: 
   ...
   [https://drive.google.com/drive/folders/10tIMSUMjgBXqoLEEZgWRlypJGR6C5_oe?usp=sharing](https://drive.google.com/drive/folders/10tIMSUMjgBXqoLEEZgWRlypJGR6C5_oe?usp=sharing)
...
## windows
   ...
   docker build -t <Image Name> <basepath/Tam-Hin-NMT-V2-AUKBC-ULCA-Deploy/>
```
Or on Ubuntu:
```bash
## ubuntu

   sudo docker build -t <Image Name> <basepath/Tam-Hin-NMT-V2-AUKBC-ULCA-Deploy/>
```
...
![App Screenshot](https://github.com/dldiscomt/DL-DiscoMT-TamHin-V2/blob/main/OutputScreenshots/Picture1.jpg?raw=true)


input :"சாதாரண அல்லது சொகுசு படகுகளில் மக்கள் ஏரியில் படகு சவாரி செய்து மகிழலாம்."
![App Screenshot ](https://github.com/dldiscomt/DL-DiscoMT-TamHin-V2/blob/main/OutputScreenshots/Picture2.jpg?raw=true)


input :"மக்கள் சைக்கிள் மற்றும் குதிரை சவாரிகளில் ஏரியைச் சுற்றி வருகிறார்கள்."
![App Screenshot](https://github.com/dldiscomt/DL-DiscoMT-TamHin-V2/blob/main/OutputScreenshots/Picture3.jpg?raw=true)
